...
class PasswordGrantAuthorization
{
     ...
     * 
     * @param \App\Resources\Contracts\Auth\AuthResourceInterface $authResource
     * @return void
     */
    public function __construct(AuthResourceInterface $authResource)
    {
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $response = $this->authResource->getAuth($headers);
